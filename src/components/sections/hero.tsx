      ...
      <div className="px-6 md:px-12 w-full">
        <div className="mx-auto max-w-7xl pt-24 md:pt-32 pb-12 md:pb-16 lg:pb-24 w-full">
          ...
          <div className="mt-12 md:mt-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 w-full">
            ...
            <div className="flex flex-col justify-between p-5 md:p-6 text-white rounded-2xl md:rounded-[32px] min-h-[280px] md:min-h-[350px] lg:min-h-[400px] transition-all duration-300 ease-out hover:scale-[1.02] hover:shadow-xl cursor-pointer overflow-hidden bg-[#0EA5E9]">
