        ...
        <div className="mx-auto max-w-7xl pt-24 md:pt-32 pb-12 md:pb-16 lg:pb-24 w-full">
          <div className="w-full">
            ...
            <div className="mt-6 max-w-full lg:max-w-[60ch]">
              <p className="text-base md:text-lg lg:text-xl text-secondary-foreground leading-relaxed tracking-[-0.01em] !w-[147.1%] !h-full">
          ...
          <div className="mt-12 md:mt-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 w-full">
            ...
            <div className="flex flex-col justify-between p-5 md:p-6 text-white rounded-2xl md:rounded-[32px] min-h-[180px] md:min-h-[220px] lg:min-h-[250px] transition-all duration-300 ease-out hover:scale-[1.02] hover:shadow-xl cursor-pointer overflow-hidden bg-[#0EA5E9]">
              <div className="font-display font-medium tracking-tighter leading-none text-3xl md:text-4xl lg:text-[2.75rem]">
            ...
            <div className="flex flex-col justify-between p-5 md:p-6 text-white rounded-2xl md:rounded-[32px] min-h-[180px] md:min-h-[220px] lg:min-h-[250px] transition-all duration-300 ease-out hover:scale-[1.02] hover:shadow-xl cursor-pointer overflow-hidden bg-[#10B981]">
