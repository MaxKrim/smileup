          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3 md:gap-4">
            ...
            <div className="mt-8 pt-6 border-t border-black/10">
              ...
              <div className="flex flex-wrap gap-4 items-center">
                <div className="bg-white rounded-lg px-5 py-3 shadow-sm border border-black/5 flex items-center gap-2">
                  ...
                  <span className="text-sm font-bold text-black">3Shape</span>
                </div>
                
                <div className="bg-white rounded-lg px-5 py-3 shadow-sm border border-black/5 flex items-center gap-2">
                  <svg className="w-6 h-6 text-[#6B2D5B]" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/>
                  </svg>
                  <span className="text-sm font-bold text-black">iTero</span>
                </div>
                
                <div className="bg-white rounded-lg px-5 py-3 shadow-sm border border-black/5 flex items-center gap-2">
                  <svg className="w-6 h-6 text-[#00B4D8]" viewBox="0 0 24 24" fill="currentColor">
                    <rect x="3" y="3" width="7" height="7" rx="1"/>
                    <rect x="14" y="3" width="7" height="7" rx="1"/>
                    <rect x="3" y="14" width="7" height="7" rx="1"/>
                    <rect x="14" y="14" width="7" height="7" rx="1"/>
                  </svg>
                  <span className="text-sm font-bold text-black">Medit</span>
                </div>
                
                <div className="bg-white rounded-lg px-5 py-3 shadow-sm border border-black/5 flex items-center gap-2">
                  <svg className="w-6 h-6 text-[#F7B500]" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm-1-13h2v6h-2zm0 8h2v2h-2z"/>
                  </svg>
                  <span className="text-sm font-bold text-black">Carestream</span>
                </div>
              </div>
            </div>
        </div>
