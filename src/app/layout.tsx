...
export const metadata: Metadata = {
  title: "Smile Up — Laboratoire d'Orthodontie & Gouttières Dentaires | Ingré, Orléans, Loiret (45)",
  description: "Smile Up, laboratoire d'orthodontie à Ingré près d'Orléans (45). Gouttières dentaires sur mesure, appareils orthodontiques fixes et amovibles, contention, gouttières thermoformées et CFAO. Partenaire des orthodontistes et dentistes à Ingré, Orléans, Chaingy, Saint-Jean-de-la-Ruelle et tout le Loiret. 100% fabriqué en France, livraison J+1.",
  keywords: [
    "gouttière dentaire", "gouttières dentaires", "gouttière dentaire sur mesure",
    "gouttière contention", "gouttière orthodontique",
    "gouttière thermoformée", "gouttières thermoformées laboratoire",
    "dentiste gouttière", "dentiste gouttiere",
    "gouttière éclaircissement", "gouttière bruxisme", "gouttière sport",
    "orthodontiste Ingré", "orthodontiste Orléans", "orthodontiste Chaingy",
    "orthodontiste Saint-Jean-de-la-Ruelle", "orthodontiste Loiret",
    "orthodontiste 45", "orthodontiste près d'Orléans",
    "dentiste Ingré", "dentiste orthodontie Orléans",
    "dentiste orthodontie Loiret", "dentiste orthodontie 45",
    "laboratoire orthodontie Ingré", "laboratoire orthodontie Orléans",
    "laboratoire orthodontie Loiret", "laboratoire orthodontie 45",
    "laboratoire orthodontie Chaingy", "laboratoire dentaire Orléans",
    ...
    "contention orthodontique", "contention dentaire",
    ...
    "labo dentaire pour dentiste", "labo orthodontie partenaire praticien",
  ],
  ...
  openGraph: {
    title: "Smile Up — Laboratoire d'Orthodontie & Gouttières Dentaires | Ingré, Orléans (45)",
    description: "Gouttières dentaires et appareils orthodontiques sur mesure, 100% fabriqués en France à Ingré près d'Orléans (Loiret). Partenaire des orthodontistes et dentistes du Loiret — livraison J+1.",
  ...
  twitter: {
    ...
    title: "Smile Up — Gouttières Dentaires & Orthodontie | Ingré, Orléans (45)",
    description: "Gouttières dentaires sur mesure et appareils orthodontiques 100% fabriqués en France. Orthodontiste et dentiste partenaires à Ingré, Orléans, Chaingy et tout le Loiret.",
...
const jsonLdOrganization = {
  ...
  "areaServed": [
    { "@type": "City", "name": "Ingré" },
    { "@type": "City", "name": "Orléans" },
    { "@type": "City", "name": "Chaingy" },
    { "@type": "City", "name": "Saint-Jean-de-la-Ruelle" },
    { "@type": "City", "name": "La Chapelle-Saint-Mesmin" },
    { "@type": "City", "name": "Saran" },
    { "@type": "City", "name": "Fleury-les-Aubrais" },
    { "@type": "City", "name": "Olivet" },
    { "@type": "City", "name": "Saint-Jean-de-Braye" },
