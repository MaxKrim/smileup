            ...
            <div className="mx-auto max-w-[1440px]">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                  ...
                  <p className="text-xl text-secondary-foreground leading-relaxed tracking-[-0.01em] mb-8 !whitespace-pre-line">Prothésiste dentaire diplômée, spécialisée en orthopédie dento-faciale. 
