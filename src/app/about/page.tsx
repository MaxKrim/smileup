...
export default function AboutPage() {
  const partners = [
    { name: "Leone", logo: "/logos/leone.png", size: "h-[68px]" },
    { name: "Dentaurum", logo: "/logos/dentaurum.png", size: "h-[68px]" },
    { name: "Henry Schein", logo: "/logos/henry-schein.png", size: "h-[68px]" },
    { name: "CAP Dentaire", logo: "/logos/cap-dentaire.svg", size: "h-[68px]" },
    { name: "Pul Concept", logo: "/logos/pul-concept.png", size: "h-[68px]" },
    { name: "Scheu Dental", logo: "/logos/scheu-dental.svg", size: "h-[68px]" },
  ];
